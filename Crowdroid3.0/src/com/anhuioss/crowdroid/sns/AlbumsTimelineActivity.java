	...
	private OnItemClickListener onItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (position + 1 == data.size()
			 ...
			 timeLineDataList.get(position).getUserInfo().getScreenName());
			...
			if ("-1".equals(timeLineDataList.get(position).getFeedType())) {
				Toast.makeText(AlbumsTimelineActivity.this, "仅用户自己可见",
					...
					.equals(timeLineDataList.get(position).getFeedType())
					|| "3".equals(timeLineDataList.get(position).getFeedType())
					|| "1".equals(timeLineDataList.get(position).getFeedType())) {
				Intent browse = new Intent(AlbumsTimelineActivity.this,
						BrowseAlbumPhotosActivity.class);
				browse.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
				Bundle bundle = new Bundle();
				...
				browse.putExtras(bundle);
				startActivity(browse);
			} else if ("4".equals(timeLineDataList.get(position).getFeedType())) {
								...
								new android.content.DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										bundle.putString("password", edit
												.getText().toString());
										bundle.putString("uid", timeLineDataList.get(current_position)
												.getUserInfo().getUid());
										bundle.putString("aid", timeLineDataList.get(current_position)
												.getStatusId());
										bundle.putString("visible", timeLineDataList.get(current_position)
												.getFeedType());
										bundle.putString("name", timeLineDataList.get(current_position)
												.getUserInfo().getScreenName());
										browse.putExtras(bundle);
										startActivity(browse);
									}
