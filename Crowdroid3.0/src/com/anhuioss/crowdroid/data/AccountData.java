...
public class AccountData {
	...
	public String getAccountXML() {
		...
		accountXML.append("<account>").append("<at_message_id>")
				.append(lastAtMessageId).append("</at_message_id>")
				.append("<direct_message_id>").append(lastDirectMessageId)
				.append("</direct_message_id>").append("<general_message_id>")
				.append(lastGeneralMessageId).append("</general_message_id>")
