...
public class ListCActivity extends TimelineActivity implements
		ServiceConnection {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		AccountData account = crowdroidApplication.getAccountList().getCurrentAccount();
		ArrayList<ListInfo> listInfoList = crowdroidApplication.getListInfoList().getListsByUserName(account.getUserName());
		
		String fullName = listInfoList.get(2).getFullName(); 
		...
		map.put("user", user);
		map.put("id", listInfoList.get(2).getId());
