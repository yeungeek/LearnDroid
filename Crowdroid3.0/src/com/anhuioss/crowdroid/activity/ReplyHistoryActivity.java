...
//				}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(this, data,
				R.layout.basic_timeline_layout_list_item, new String[] {
						"screenName", "status", "userImage", "webviewstatus" ,"time" ,"moreTweets"},
				new int[] { R.id.screen_name, R.id.status, R.id.user_image,R.id.web_view_status,
	...
	private void createListView(TimeLineInfo timelineInfo) {
		...
		if(statusData.getCurrentService().equals(IGeneral.SERVICE_NAME_TWITTER)){
			map.put("screenName", timelineInfo.getUserInfo().getUserName()+" "+"@"+timelineInfo.getUserInfo().getScreenName());
		} else {
		...
		map.put("time", timelineInfo.getFormatTime(statusData
				.getCurrentService()));
