			...
			if (!message.equals("")) {
				...
				//retweet message
					...
					SharedPreferences sharedPreferences = mContext
							.getSharedPreferences("SHARE_INIT_RETWEET_STATUS", 0);
					SharedPreferences.Editor editor = sharedPreferences.edit();
					editor.putString("SHARE_INIT_RETWEET_STATUS", str.toString());
					editor.putBoolean("WHEATHER_FROM_RETWEET_OUTSIDE_INSERT", true);
					editor.commit();					
				}
				//comment message
				else if (message.equals("comment_message")) {
					SharedPreferences sharedPreferences = mContext
							.getSharedPreferences("SHARE_INIT_COMMENT_STATUS", 0);
					SharedPreferences.Editor editor = sharedPreferences.edit();
					editor.putString("SHARE_INIT_COMMENT_STATUS", str.toString());
					editor.putBoolean("WHEATHER_FROM_COMMENT_OUTSIDE_INSERT", true);
					editor.commit();
				}
				dismiss();
			}
