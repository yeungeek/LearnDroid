...
public class AddTranslationDataActivity extends BasicAddPreferenceActivity {
		...
		public boolean onPreferenceClick(Preference preference) {
			...
			if("Baidu".equals(TRANSLATION_ENGINE_FLAG)){
				...
				ArrayAdapter<String> baiduLanguageSelectAdapter = new ArrayAdapter<String>(
						AddTranslationDataActivity.this , android.R.layout.simple_spinner_item, baiduLanguageNames);
				baiduLanguageSelectAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
				...
				spinnerFrom.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						// TODO select language from ,then adapter language to
						ArrayList<String> languageBaiduNameList = new ArrayList<String>();
						if(position == 0){
							String[] languageBaiduNames = { ENGLISH , JAPANISE };
						...
						ArrayAdapter<String> languageBaiduSelectAdapter = new ArrayAdapter<String>(
								AddTranslationDataActivity.this, android.R.layout.simple_spinner_item,
			...
			AlertDialog dlg = new AlertDialog.Builder(
				AddTranslationDataActivity.this).setTitle(R.string.add)
				.setView(textEntryView).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							
							// Find View
							EditText userNameForTranslation = (EditText)
							textEntryView.findViewById(R.id.dialog_add_translation_name);
							
							// New Instance
							TranslationData translationData = new TranslationData();
							
							// Set Data
							translationData.setService(statusData.getCurrentService());
							translationData.setUserName(userNameForTranslation.getText().toString());
							
							if("Baidu".equals(TRANSLATION_ENGINE_FLAG)){
								translationData.setFrom(languageBaiduValues[spinnerFrom.getSelectedItemPosition()]);
								switch(spinnerFrom.getSelectedItemPosition()){
								case 0:{
								...
								translationData.setFrom(languageValues[spinnerFrom.getSelectedItemPosition()]);
								translationData.setTo(languageValues[spinnerTo.getSelectedItemPosition()]);
							}
							
							
							// Add Data To List
							translationList.addTranslationData(translationData);
	...
	private Preference.OnPreferenceClickListener itemClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			...
			AlertDialog dlg = new AlertDialog.Builder(
					AddTranslationDataActivity.this).setTitle(R.string.confirm)
					.setMessage(R.string.whether_delete).setPositiveButton(
							R.string.ok, new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int whichButton) {

									TranslationData translationData = translationList.getTranslationData(statusData.getCurrentService()).get(id);
									
									// Delete
									translationList.removeTranslationData(translationData);
	...
	public void onStart() {
		...
		initView(getString(R.string.setting_translation_add_auto_translation), "",
				getString(R.string.setting_translation_auto_translation_list), null,
