...
public class AddRenRenAccountActivity extends BasicAddPreferenceActivity {
	...
	private Preference.OnPreferenceClickListener addClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			Intent intent = new Intent(AddRenRenAccountActivity.this, RegisterRenRenAccountActivity.class);
	...
	private Preference.OnPreferenceClickListener itemClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
	    	...
	    	AlertDialog dlg = new AlertDialog.Builder(AddRenRenAccountActivity.this)
	        .setTitle(R.string.confirm)
	        .setMessage(R.string.whether_delete)
	        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
	            public void onClick(DialogInterface dialog, int whichButton) {

	            	AccountData account = accountList.getAccountByService(IGeneral.SERVICE_NAME_RENREN).get(id);
	...
	public void onStart() {
		...
		initView(getString(R.string.add_renren_account), "", getString(R.string.renren_account_list), 
	...
	protected void createItemList() {
		...
		for (AccountData account : accountList.getAccountByService(IGeneral.SERVICE_NAME_RENREN)) {
