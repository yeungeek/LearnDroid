...
public class SelectColorDialog extends Dialog implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		crowdroidApplaication = (CrowdroidApplication) mContext.getApplicationContext();
	...
	protected void initView() {
		...
		if(color != 0){
			colorTextView.setBackgroundColor(mContext.getResources().getColor(color));
		} else{
			colorTextView.setBackgroundColor(mContext.getResources().getColor(R.color.white));
		}
			...
			public void onClick(View v) {
				if(selectedColor!=0)
				{
					if("fontcolorsettings".equals(key)){
						...
						settingData.setWallpaperPath(String.valueOf(selectedColor));
					}
/*				
					SharedPreferences pref = PreferenceManager
							.getDefaultSharedPreferences(getContext());
					Editor editor = pref.edit();
					editor.putString(key, String.valueOf(selectedColor));
					editor.commit();*/
				}
...
//
//			Toast.makeText(mContext, selectedColor, Toast.LENGTH_SHORT).show();
			break;
