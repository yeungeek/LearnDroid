...
public class SettingsActivity extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		translateEngineListPreference = (ListPreference) managerPrefs.findPreference("translationselection");
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
					...
					.setItems(background, new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (which == 0) { // Picture
								...
								intent.setClass(SettingsActivity.this, SelectThemeActivity.class);
		...
		// -----------------
		if(preference.getKey() !=null && preference.getKey().equals("translationselection")){
	...
	private void initPreferenceData(){
		...
		if (!radioPreStr.equals("")) {
			...
			if (key.equals("0")) {
				...
				preference.setSummary(getString(R.string.setting_casual_watch_search)
								+ ":" + summary);
			}
		}
	}
