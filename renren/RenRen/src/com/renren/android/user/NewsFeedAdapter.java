...
import com.renren.android.newsfeed.NewsFeedViewHolder;
...
public class NewsFeedAdapter extends BaseAdapter {
	...
	public int getCount() {
		return RenRenData.mNewsFeedResults.size();
	}

	public Object getItem(int position) {
		return RenRenData.mNewsFeedResults.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		int feedType = RenRenData.mNewsFeedResults.get(position).getFeed_type();
		NewsFeedViewHolder holder = null;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.user_newsfeed_item, null);
		...
		Assignment(holder, position, feedType);
		return convertView;
	}
	...
	private void FindViewById(NewsFeedViewHolder holder, View convertView) {
		...
		holder.mAvatar = (ImageView) convertView
				.findViewById(R.id.user_newsfeed_list_avatar);
		holder.mName = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_name);
		holder.mMore = (ImageButton) convertView
				.findViewById(R.id.user_newsfeed_list_more);
		holder.mContent = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_content);
		holder.mType = (ImageView) convertView
				.findViewById(R.id.user_newsfeed_list_type);
		holder.mTime = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_time);
		holder.mSource = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_source);
		holder.mComment_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_comment_root);
		holder.mComment_Count = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_comment_count);
		holder.mComment_1 = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_comment_1);
		holder.mComment_1_Time = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_comment_1_time);
		holder.mComment_2 = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_comment_2);
		holder.mComment_2_Time = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_comment_2_time);

		holder.mStatus_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_status_root);
		holder.mStatus_Name = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_status_name);
		holder.mStatus_Content = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_status_content);

		holder.mSharePhoto_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_sharephoto_root);
		holder.mSharePhoto_Name = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_sharephoto_name);
		holder.mSharePhoto_Description = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_sharephoto_description);
		holder.mSharePhoto_Image = (ImageView) convertView
				.findViewById(R.id.user_newsfeed_list_sharephoto_image);
		holder.mSharePhoto_Title = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_sharephoto_title);

		holder.mShareAlbum_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_sharealbum_root);
		holder.mShareAlbum_Name = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_sharealbum_name);
		holder.mShareAlbum_Title = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_sharealbum_title);
		holder.mShareAlbum_Image = (ImageView) convertView
				.findViewById(R.id.user_newsfeed_list_sharealbum_image);

		holder.mShareBlog_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_shareblog_root);
		holder.mShareBlog_Name = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_shareblog_name);
		holder.mShareBlog_Title = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_shareblog_title);
		holder.mShareBlog_Description = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_shareblog_description);

		holder.mPublishBlog_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_publishblog_root);
		holder.mPublishBlog_Title = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_publishblog_title);
		holder.mPublishBlog_Description = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_publishblog_description);

		holder.mPublishPhoto_Root = (LinearLayout) convertView
				.findViewById(R.id.user_newsfeed_list_publishphoto_root);
		holder.mPublishPhoto_Content = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_publishphoto_content);
		holder.mPublishPhoto_Image = (ImageView) convertView
				.findViewById(R.id.user_newsfeed_list_publishphoto_image);
		holder.mPublishPhoto_Title = (TextView) convertView
				.findViewById(R.id.user_newsfeed_list_publishphoto_title);
	}

	public void Assignment(NewsFeedViewHolder holder, int position, int feedType) {
		NewsFeedResult result = RenRenData.mNewsFeedResults.get(position);
		...
		if (result.getAttachment_count() > 0
			...
			mText_Util.addIntentLinkToFriendInfo(mContext, mActivity,
					...
					0, result.getAttachment_owner_name().length(),
					result.getAttachment_owner_id());
			holder.mShareBlog_Title.setText(result.getTitle());
		...
		if (feedType == 20 || feedType == 22) {
			...
			holder.mPublishBlog_Title.setText(result.getTitle());
