...
public class PhotosImageView extends ImageView {
	...
	private void arithScaleRate() {
		float scaleWidth = PhotosDetailActivity.mScreenWidth
				/ (float) imageWidth;
		float scaleHeight = PhotosDetailActivity.mScreenHeight
				/ (float) imageHeight;
	...
	public void layoutToCenter() {
		...
		float fill_width = PhotosDetailActivity.mScreenWidth - width;
		float fill_height = PhotosDetailActivity.mScreenHeight - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom = (PhotosDetailActivity.mScreenWidth / 2f) / imageWidth;
