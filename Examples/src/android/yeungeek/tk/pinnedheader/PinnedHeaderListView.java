...
public class PinnedHeaderListView extends ListView {
    ...
    public void configureHeaderView(int position) {
        ...
        // boolean isShown = firstView.findViewById(R.id.search_text).isShown();
        //
        // Log.d("PinnedHeader", "position:" + position + ", state:" + state +
        // ",isShown" + isShown);
        // if (isShown) {
        ...
        switch (state) {
            ...
            case PinnedHeaderAdapter.PINNED_HEADER_PUSHED_UP: {
                View firstView = getChildAt(0);
                Log.d("HeaderView", "<<<<<<" + firstView.getId() + ", header_text vis:"
                        + firstView.findViewById(R.id.header_text).getVisibility());

                TextView tv = (TextView) firstView.findViewById(android.R.id.text1);
                Log.d("HeaderView", "sample text:" + tv.getText().toString());
