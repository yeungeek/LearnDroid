...
public class BingTranslationHandler extends HttpCommunicator {
	 ...
	 */
	// -----------------------------------------------------------------------------------------------
	public static CommResult detect(String query)
			throws UnsupportedEncodingException {

		CommResult result = new CommResult();

		// Prepare Parameters
		String url = "http://api.microsofttranslator.com/v2/Http.svc/Detect?appId="
				+ APIKEY + "&text=" + URLEncoder.encode(query, HTTP.UTF_8);
