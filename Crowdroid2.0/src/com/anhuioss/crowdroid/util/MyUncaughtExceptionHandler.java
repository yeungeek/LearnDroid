...
public class MyUncaughtExceptionHandler implements UncaughtExceptionHandler {
	...
	// "http://192.168.1.108/crowdroid_bugreport/bugreport.php";
	...
	private void forceLogout() {
		...
		activityManager.restartPackage(sContext.getPackageName());

		activityManager.killBackgroundProcesses(sContext.getPackageName());
	...
	private static void postBugReport() {
		...
		try {
			HttpPost httpPost = new HttpPost(Constants.BUG_REPORT_URL);
			...
			HttpConnectionParams.setConnectionTimeout(params, 5000); // Set
																		...
																		// Time
																		// Out
			HttpConnectionParams.setSoTimeout(params, 5000); // Set Data Require
																// Time Out
