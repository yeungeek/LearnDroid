...
public class SelectReplayUserDialog extends AlertDialog {
	...
	public SelectReplayUserDialog(Context context, String[] replyList,
		...
		View layoutView = inflater.inflate(R.layout.dialog_select_replay_user,
				null);
		setView(layoutView);
		...
		// List View
		replyNameListView = (ListView) layoutView
				.findViewById(R.id.dialog_select_replay_user_listView);
		...
		replyNameListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (selectedNameList.contains(((CheckedTextView) arg1)
						.getText().toString())) {
					selectedNameList.remove(((CheckedTextView) arg1).getText()
							.toString());
				} else {
					selectedNameList.add(((CheckedTextView) arg1).getText()
							.toString());
				}
		...
		// Check Box
		replyAllCheckBox = (CheckBox) layoutView
				.findViewById(R.id.dialog_select_replay_all_user_checkBox);
		replyAllCheckBox
		...
		setButton(DialogInterface.BUTTON_POSITIVE,
				mContext.getString(R.string.ok), new OnClickListener() {
