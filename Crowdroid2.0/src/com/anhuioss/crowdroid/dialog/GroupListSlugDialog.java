		...
		slugListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				if (listInfoList.size() > 0) {
					final CharSequence[] groupOperate = mContext.getResources()
							.getStringArray(R.array.group_list_slug_operate);
					AlertDialog dialog = new AlertDialog.Builder(mContext)
							.setItems(groupOperate, new OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									if (which == 0) {
										// group timeline
										Intent timeline = new Intent(mContext,
												GroupTimelineActivity.class);
										Bundle bundle = new Bundle();
										bundle.putString("group_timeline_slug",
												listInfoList.get(position)
														.getSlug());
										bundle.putString(
												"group_timeline_owner",
												listInfoList.get(position)
														.getUserInfo()
														.getScreenName());
										bundle.putString("group_timeline_id",
												listInfoList.get(position)
														.getId());
										...
										// group users
										Intent userList = new Intent(mContext,
												GroupListUserActivity.class);
										Bundle bundle = new Bundle();
										bundle.putString("group_list_slug",
												listInfoList.get(position)
														.getSlug());
										bundle.putString("group_list_owner",
												listInfoList.get(position)
														.getUserInfo()
														.getScreenName());
										bundle.putString("group_list_id",
												listInfoList.get(position)
														.getId());
										...
										Bundle bundle = new Bundle();
										bundle.putString("name", listInfoList
												.get(position).getUserInfo()
												.getScreenName());
										bundle.putString("user_name",
												listInfoList.get(position)
														.getUserInfo()
														.getUserName());
										bundle.putString("uid", listInfoList
												.get(position).getUserInfo()
												.getUid());
