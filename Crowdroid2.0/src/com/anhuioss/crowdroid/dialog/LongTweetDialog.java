...
public class LongTweetDialog extends Dialog implements ServiceConnection {
		...
		public void requestCompleted(String service, int type,
			...
			if (statusCode != null && statusCode.equals("200")) {
				...
				if (message != null) {
					...
					String url = (String) parseHandler.parser(service, type,
							statusCode, message);

					shrinkedMsg.setText(combine(originalMsg.getText()
							.toString(), url));
	...
	public LongTweetDialog(Context context, EditText target) {
		...
		// super.
		setContentView(R.layout.dialog_long_tweet);
	...
	private void shrinkMessage() {
		...
		try {
			apiServiceInterface.request(accountData.getService(),
					CommHandler.TYPE_REGISTER_MESSAGE_TO_API,
