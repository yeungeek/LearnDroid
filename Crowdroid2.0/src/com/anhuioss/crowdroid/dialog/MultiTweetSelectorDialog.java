...
public class MultiTweetSelectorDialog extends AlertDialog {
	...
	public MultiTweetSelectorDialog(Context context,
			ArrayList<AccountData> multiTweetAccount) {
		super(context);
		...
		View layoutView = inflater.inflate(
				R.layout.dialog_multi_tweet_selector, null);
		setView(layoutView);
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						for (int i = 0; i < root.getChildCount(); i++) {
							...
							if (!(IGeneral.SERVICE_NAME_CROWDROID_FOR_BUSINESS
									.equals(view.getText())
									|| IGeneral.SERVICE_NAME_SINA.equals(view
											.getText())
									|| IGeneral.SERVICE_NAME_TENCENT
											.equals(view.getText())
									|| IGeneral.SERVICE_NAME_SOHU.equals(view
											.getText())
									|| IGeneral.SERVICE_NAME_TWITTER
											.equals(view.getText()) || IGeneral.SERVICE_NAME_TWITTER_PROXY
										.equals(view.getText()))
									&& view.isChecked()) {
								multiTweetAccountSelected.add(view.getText()
										.toString() + view.getTag().toString());
							}
						}
						SendMessageActivity
								.setMultiTweetSelected(multiTweetAccountSelected);
					}
	...
	private void changeMultiTweetAccount(
			ArrayList<HashMap<String, String>> multiMessages) {
