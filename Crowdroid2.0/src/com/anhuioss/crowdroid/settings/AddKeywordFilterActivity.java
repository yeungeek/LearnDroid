...
public class AddKeywordFilterActivity extends BasicAddPreferenceActivity {
	...
	private Preference.OnPreferenceClickListener addClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			...
			LayoutInflater factory = LayoutInflater
					.from(AddKeywordFilterActivity.this);
			final View textEntryView = factory.inflate(
					R.layout.dialog_add_keyword_filter, null);

			AlertDialog dlg = new AlertDialog.Builder(
					AddKeywordFilterActivity.this)
					...
					.setPositiveButton(R.string.ok,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int whichButton) {
									EditText keywordEditText = (EditText) textEntryView
									...
									if (keywordFilterList.getAllKeywords()
											.size() > 0) {
										boolean flag = true;
										for (int i = 0; i < keywordFilterList
												.getAllKeywords().size(); i++) {

											if (keywordEditText
													.getText()
													.toString()
													.equals(keywordFilterList
															.getAllKeywords()
															.get(i)
															.getKeyword())) {
												flag = false;
					...
					.setPositiveButton(R.string.ok,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									KeywordFilterData keyword = keywordFilterList
											.getAllKeywords().get(id);
	...
	public void onStart() {
		...
		initView(getResources().getString(R.string.setting_add_keyword_filter),
				"",
				getResources().getString(R.string.setting_keyword_filter_list),
	...
	protected void createItemList() {
		...
		for (KeywordFilterData keywordFilter : keywordFilterList
				.getAllKeywords()) {
