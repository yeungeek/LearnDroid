...
public class RegisterSinaAccountActivity extends Activity implements
	...
	public static final String SINA_API_KEY = "4097074858";

	public static final String SINA_API_SECRET = "e6c623e6d434130245901e9a859c200a";
	...
	private ApiServiceListener.Stub apiServiceListener = new ApiServiceListener.Stub() {
		...
		public void requestCompleted(String service, int type,
			...
			if (statusCode != null && statusCode.equals("200")) {
				...
				Toast.makeText(RegisterSinaAccountActivity.this, "null",
	...
	private void loadRequestURL() {
		...
		webView.setWebViewClient(new RegisterSinaAccountActivity.WeiboWebViewClient());
		String display = "default";
		if (isPhoneDevice()) {
			display = "mobile";
		}
		webView.loadUrl("https://api.weibo.com/oauth2/authorize?"
				+ "client_id=" + SINA_API_KEY + "&response_type=code"
				+ "&display=" + display
	...
	public static TokenInfo parseAccessToken(String msg) throws Exception {
		...
		tokenInfo.setRemindIn(token.getString("remind_in"));
