...
public class AddUserFilterActivity extends BasicAddPreferenceActivity {
	...
	private Preference.OnPreferenceClickListener addClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			...
			LayoutInflater factory = LayoutInflater
					.from(AddUserFilterActivity.this);
			final View textEntryView = factory.inflate(
					R.layout.dialog_add_user_filter, null);
			...
			if (IGeneral.APPLICATION_MODE == 0) {
				adapter = ArrayAdapter.createFromResource(
						AddUserFilterActivity.this, R.array.services,
						android.R.layout.simple_spinner_item);
			} else if (IGeneral.APPLICATION_MODE == 1) {
				adapter = ArrayAdapter.createFromResource(
						AddUserFilterActivity.this, R.array.service_less,
						android.R.layout.simple_spinner_item);
			}
					...
					.setPositiveButton(R.string.ok,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									userFilterData.setUserName(userName
											.getText().toString());
									userFilterData.setService(service
											.getSelectedItem().toString());
									userFilterList
											.addUserFilter(userFilterData);
					...
					.setPositiveButton(R.string.ok,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									UserFilterData userFilter = userFilterList
											.getAllUserFilter().get(id);
	...
	public void onStart() {
		...
		initView(getResources().getString(R.string.setting_add_user_filter),
				"",
				getResources().getString(R.string.setting_user_filter_list),
