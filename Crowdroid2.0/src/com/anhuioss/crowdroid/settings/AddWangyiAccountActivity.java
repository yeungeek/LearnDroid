...
public class AddWangyiAccountActivity extends BasicAddPreferenceActivity {
	...
	private Preference.OnPreferenceClickListener addClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			Intent intent = new Intent(AddWangyiAccountActivity.this,
					RegisterWangyiAccountActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == 0 && data != null) {
			...
			if (bundle != null) {
				...
				account.setUid(uid);
				account.setService(IGeneral.SERVICE_NAME_WANGYI);
	...
	public void onStart() {
		...
		initView(getString(R.string.add_wangyi_account), "",
				getString(R.string.wangyi_account_list), null,
	...
	protected void createItemList() {
		...
		for (AccountData account : accountList
				.getAccountByService(IGeneral.SERVICE_NAME_WANGYI)) {
