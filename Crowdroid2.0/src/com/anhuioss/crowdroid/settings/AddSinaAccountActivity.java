...
public class AddSinaAccountActivity extends BasicAddPreferenceActivity {
	...
	private Preference.OnPreferenceClickListener addClickedListener = new Preference.OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference preference) {
			Intent intent = new Intent(AddSinaAccountActivity.this,
					RegisterSinaAccountActivity.class);
	...
	public void onStart() {
		...
		initView(getString(R.string.add_sina_account), "",
				getString(R.string.sina_account_list), null,
