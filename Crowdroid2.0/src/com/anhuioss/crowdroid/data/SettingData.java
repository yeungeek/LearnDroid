...
public class SettingData {
	...
	private boolean DEFAULT_AUTO_BROADCAST = true;
	 ...
	 */
	// ----------------------------------------------------------------------------------
	public void setNewestVersionData(String message) {
		editor.putString("newest-version-message", message).commit();
	}

	public String getNewestVersionData() {
		String message = prefs.getString("newest-version-message", null);
		return message;
	}
	...
	// ----------------------------------------------------------------------------------
	/**
	 * Check whether auto broadcast function is enabled
	 * 
	 * @return boolean autoBroadcast
	 */
	// ----------------------------------------------------------------------------------
	public boolean isAutoBroadcast() {
		boolean autoBroadcast = prefs.getBoolean("autobroadcastcheck",
