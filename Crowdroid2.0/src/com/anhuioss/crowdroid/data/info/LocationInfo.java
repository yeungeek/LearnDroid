...
public class LocationInfo {
	...
	public void setRounterLine(String rounterLine) {
		this.rounterLine = rounterLine;
	}

	public String getRounterLine() {
		return rounterLine;
	}
	...
	public String getLoationCityCode() {
