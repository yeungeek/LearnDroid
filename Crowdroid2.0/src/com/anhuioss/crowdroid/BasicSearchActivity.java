...
public class BasicSearchActivity extends BasicActivity implements
		...
		case CommHandler.TYPE_SEARCH_INFO: {
			if (getIntent().getExtras().containsKey("TencentTrendSearchFlag")) {
				headName.setText(R.string.discovery_tencent_trend_search);
					...
					.containsKey("SohuSearchTypeFlag")) {
				headName.setText(R.string.discovery_sohu_status_search);
			} else {
	 ...
	 * 保存关键字搜索的历史记录
	 */
	private void saveKeywordSearchHistory() {
		...
		if (statusData.getCurrentService().equals(
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("tencent_history", sb.toString()).commit();
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("twitter_history", sb.toString()).commit();
	 ...
	 * 保存用户时间线搜索的历史记录
	 */
	private void saveUserTimelineSearchHistory() {

		String text = searchText.getText().toString();
		if (statusData.getCurrentService().equals(
				IGeneral.SERVICE_NAME_CROWDROID_FOR_BUSINESS)) {// cfb历史记录
			SharedPreferences sp = getSharedPreferences(
					"user_cfb_history_strs", 0);
			String save_Str = sp.getString("user_cfb_history", "");
			String[] hisArrays = save_Str.split(",");
			for (int i = 0; i < hisArrays.length; i++) {
				if (hisArrays[i].equals(text)) {
					return;
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_cfb_history", sb.toString()).commit();
		} else if (statusData.getCurrentService().equals( // sina历史记录
				IGeneral.SERVICE_NAME_SINA)) {
			SharedPreferences sp = getSharedPreferences(
					"user_sina_history_strs", 0);
			String save_Str = sp.getString("user_sina_history", "");
			String[] hisArrays = save_Str.split(",");
			for (int i = 0; i < hisArrays.length; i++) {
				if (hisArrays[i].equals(text)) {
					return;
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_sina_history", sb.toString()).commit();
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_sohu_history", sb.toString()).commit();

		} else if (statusData.getCurrentService().equals( // tencent历史记录
				IGeneral.SERVICE_NAME_TENCENT)) {
			SharedPreferences sp = getSharedPreferences(
					"user_tencent_history_strs", 0);
			String save_Str = sp.getString("user_tencent_history", "");
			String[] hisArrays = save_Str.split(",");
			for (int i = 0; i < hisArrays.length; i++) {
				if (hisArrays[i].equals(text)) {
					return;
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_tencent_history", sb.toString()).commit();

		} else if (statusData.getCurrentService().equals( // twitter历史记录
				IGeneral.SERVICE_NAME_TWITTER)) {
			SharedPreferences sp = getSharedPreferences(
					"user_twitter_history_strs", 0);
			String save_Str = sp.getString("user_twitter_history", "");
			String[] hisArrays = save_Str.split(",");
			for (int i = 0; i < hisArrays.length; i++) {
				if (hisArrays[i].equals(text)) {
					return;
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_twitter_history", sb.toString()).commit();

		} else if (statusData.getCurrentService().equals( // twitter-proxy历史记录
				IGeneral.SERVICE_NAME_TWITTER_PROXY)) {
			SharedPreferences sp = getSharedPreferences(
					"user_twitter_proxy_history_strs", 0);
			String save_Str = sp.getString("user_twitter_proxy_history", "");
			String[] hisArrays = save_Str.split(",");
			for (int i = 0; i < hisArrays.length; i++) {
				if (hisArrays[i].equals(text)) {
					return;
			...
			StringBuilder sb = new StringBuilder(save_Str);
			sb.append(text + ",");
			sp.edit().putString("user_twitter_proxy_history", sb.toString())
					.commit();
		}
	}
	 ...
	 * 提取关键字搜索历史
	 */
	private void getKeywordSearchHistory() {
		if (statusData.getCurrentService().equals(
				IGeneral.SERVICE_NAME_CROWDROID_FOR_BUSINESS)) {// cfb历史记录
			SharedPreferences sp = getSharedPreferences("cfb_history_strs", 0);
	 ...
	 * 提取用户时间线搜索历史
	 */
	private void getUserTimelineSearchHistory() {
		if (statusData.getCurrentService().equals(
				IGeneral.SERVICE_NAME_CROWDROID_FOR_BUSINESS)) {// cfb历史记录
			SharedPreferences sp = getSharedPreferences(
					"user_cfb_history_strs", 0);
			String save_history = sp.getString("user_cfb_history", "");
			String[] hisArrays = save_history.split(",");
			cfb_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
			...
			SharedPreferences sp = getSharedPreferences(
					"user_sina_history_strs", 0);
			String save_history = sp.getString("user_sina_history", "");
			String[] hisArrays = save_history.split(",");
			sina_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
			...
			searchText.setAdapter(sina_adapter_history);
				...
				IGeneral.SERVICE_NAME_SOHU)) {
			SharedPreferences sp = getSharedPreferences(
					"user_sohu_history_strs", 0);
			String save_history = sp.getString("user_sohu_history", "");
			String[] hisArrays = save_history.split(",");
			sohu_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
			...
			SharedPreferences sp = getSharedPreferences(
					"user_tencent_history_strs", 0);
			String save_history = sp.getString("user_tencent_history", "");
			String[] hisArrays = save_history.split(",");
			tencent_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
			...
			SharedPreferences sp = getSharedPreferences(
					"user_twitter_history_strs", 0);
			String save_history = sp.getString("user_twitter_history", "");
			String[] hisArrays = save_history.split(",");
			twitter_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
			...
			SharedPreferences sp = getSharedPreferences(
					"user_twitter_proxy_history_strs", 0);
			String save_history = sp
					.getString("user_twitter_proxy_history", "");
			String[] hisArrays = save_history.split(",");
			twitter_proxy_adapter_history = new ArrayAdapter<String>(this,
					android.R.layout.simple_dropdown_item_1line, hisArrays);
			if (hisArrays.length > 50) {
